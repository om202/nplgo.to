                ...
                <Card className="border-border/60">
                    <CardContent className="prose prose-sm max-w-none pt-6 space-y-6">
                        ...
                        <section>
                            ...
                            <h3 className="text-base font-medium mt-3 mb-1.5">Account Creation</h3>
                            <p className="text-sm text-muted-foreground leading-relaxed">
                            ...
                            <h3 className="text-base font-medium mt-3 mb-1.5">Account Termination</h3>
                            <p className="text-sm text-muted-foreground leading-relaxed">
                        ...
                        <section>
                            ...
                            <p className="text-sm text-muted-foreground leading-relaxed">You agree NOT to use the Service to:</p>
                            <ul className="list-disc pl-6 text-sm text-muted-foreground space-y-1">
                        ...
                        <section>
                            <h2 className="text-lg font-semibold mb-2">Content and Ownership</h2>
                            <h3 className="text-base font-medium mt-3 mb-1.5">Your Content</h3>
                            <p className="text-sm text-muted-foreground leading-relaxed">
                            ...
                            <h3 className="text-base font-medium mt-3 mb-1.5">Our Content</h3>
                            <p className="text-sm text-muted-foreground leading-relaxed">
                        ...
                        <section>
                            <h2 className="text-lg font-semibold mb-2">Link Expiration and Deletion</h2>
                            <p className="text-sm text-muted-foreground leading-relaxed">
